...
<div class="btn_blk">
	...
	<div class="fr">
		<a href="admin/collect/delete" class="btn2 fr ml20  del_all">删除</a>
		<a href="admin/collect/create" class="btn1 fr">采集</a>
	</div>
</div>
...
<form action="admin/collect/delete" method="post" accept-charset="utf-8" id="res_del">
<table width="100%" class="table_list">
	...
	<tr <?php if (($key+1) % 2) {?>class="odd"<?php }?>>
		...
		<td class="tc">
			<a href="admin/collect/update/<?php echo $val['id'];?>"><img src="application/views/admin/images/i.gif" class="ico_edit" title="编辑"></a> &nbsp;&nbsp;
			<a href="admin/collect/delete/<?php echo $val['id'];?>" class="delete"><img src="application/views/admin/images/i.gif" class="ico_del" title="删除"></a>
		</td>
	</tr>
	<?php endforeach;?>
	<?php else: ?>
    <tr class="even">
    	<td colspan="7">没有任何采集文章</td>
    </tr>
    <?php endif; ?>
</table>
</form>
